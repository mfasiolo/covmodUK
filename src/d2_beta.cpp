...
double d2_beta(arma::mat& X,  arma::mat& eta,  arma::mat& y,  Rcpp::List& jj,  uint32_t& K,
               ...
               arma::vec& l2_el, arma::vec& l2_el2){
  ...
  for(i = 0; i < size_g; i++){
    ...
    if ( i < (size_g - 1) ) {
      d2_mcd_eta(eta.rows(igf, igl), y.rows(igf, igl), l2, l2_v, z, w, G, t, b1_eta, b3, ib1_eta, ib3);
    } else {
      d2_mcd_eta(eta.rows(igf, igl), y.rows(igf, igl), l2_l, l2_v_l, z, w, G, t, b1_eta, b3, ib1_eta, ib3);
    }
